...
id = 1;
     for pow = 1:10
       % u = randn(N, 1);
        ...
        for t=3:N
             y(t)= b1(t)*y(t-1)+b2(t)*y(t-2) + L(0,0,0.02);   
       ...
       % fi = [u(1:N)'; 0,u(1:N-1)'];
        ...
        [th1, fi1, ye1, ee1] = simplified_EWLS(fi, y, (6));
        [th2, fi2, ye2, ee2] = simplified_EWLS(fi, y, (18));
        [th3, fi3, ye3, ee3] = simplified_EWLS(fi, y, (54));
%         

%         [the1, eo1] = EWLS(fi, y, lambda(5));
%         [the2, eo2] = EWLS(fi, y, lambda(15));
%         [the3, eo3] = EWLS(fi, y, lambda(45));
