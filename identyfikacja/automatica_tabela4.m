...
for pow=1:10
    ...
    for t=r+1:N
        y(t) = b2(t) * y(t-2) + b1(t) * y(t-1);% + 0.02*randn(1);
        y(t) = L(y(t), 0, 0.02);
        fi(:,t) = [y(t-1);y(t-2)];
    end
    ...
    [th1, yo1, yp1] = EWLS(fi, y, (30));
    W(id, 1) =  W(id, 1)  + blad(th, th1);
    [th2, yo2, yp2] = EWLS(fi, y, (60));
    W(id, 2) =W(id, 2) +blad(th, th2);
    [th3, yo3, yp3] = EWLS(fi, y, (120));
    W(id, 3) = W(id, 3) +blad(th, th3);

    thc = C1(th1, th2, th3, yo1, yo2, yo3, 1);
    W(id, 4) = W(id, 4) + blad(th, thc);
    
    thc = C1(th1, th2, th3, yp1, yp2, yp3, 1);
    W(id, 5) = W(id, 5) + blad(th, thc);
