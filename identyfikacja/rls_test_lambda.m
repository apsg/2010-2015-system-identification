...
[th1, fi1, ye1] = ident_lambda(u, y, lambda(10));
[th2, fi2, ye2] = ident_lambda(u, y, lambda(20));
[th3, fi3, ye3] = ident_lambda(u, y, lambda(40));
...
plot(T, th3(1,:), 'b-.');
set(gca, 'YLim', [-.5,1])
title('a1'), legend('a1', '\lambda_1', '\lambda_2', '\lambda_3')
